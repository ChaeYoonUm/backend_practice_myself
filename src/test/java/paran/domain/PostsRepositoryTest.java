...
public class PostsRepositoryTest {
    ...
    public void BaseTimeEntity_등록() {
        //given
        LocalDateTime now = LocalDateTime.of(2023, 3, 17, 10, 49, 0);
        ...
        System.out.println(">>>>>>>>>> createDate="+posts.getCreaatedDate()+", modifiedDate="+posts.getModifiedDate());

        assertThat(posts.getCreaatedDate()).isAfter(now);
